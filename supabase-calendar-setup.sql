-- Calendar Sync Database Setup for Tamil Panchangam
-- Run this script in your Supabase SQL editor

-- Create user calendar preferences table
...
-- Create RLS policies for user_calendar_preferences
...
GRANT ALL ON user_calendar_preferences TO authenticated;
GRANT ALL ON calendar_subscriptions TO authenticated;
GRANT SELECT ON calendar_subscriptions TO anon;
